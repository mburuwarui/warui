defmodule Warui.Repo.Migrations.InitializeAndAddAuthenticationResourcesAndAddMagicLinkAuthAndAddPasswordAuthenticationAndAddPasswordAuthExtensions1 do
  @moduledoc """
