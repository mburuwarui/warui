defmodule WaruiWeb.Components.Menu do
  @moduledoc """
  The `WaruiWeb.Components.Menu` module is designed to render a hierarchical menu structure in
  ...
  The `WaruiWeb.Components.Menu` is ideal for creating multi-level navigation menus in
  ...
  import WaruiWeb.Components.Accordion, only: [accordion: 1]
  import WaruiWeb.Components.Button, only: [button_link: 1]
