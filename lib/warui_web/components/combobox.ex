defmodule WaruiWeb.Components.Combobox do
  @moduledoc """
  The `WaruiWeb.Components.Combobox` is a Phoenix LiveView component module for creating customizable combobox elements.
