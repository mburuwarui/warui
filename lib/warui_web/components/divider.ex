defmodule WaruiWeb.Components.Divider do
  @moduledoc """
  The `WaruiWeb.Components.Divider` module provides a versatile and customizable divider
  ...
  @doc """
  `WaruiWeb.Components.Divider.hr` is used to create a horizontal divider with customizable style, color,
  and size options.
