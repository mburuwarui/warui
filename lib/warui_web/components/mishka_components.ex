defmodule WaruiWeb.Components.MishkaComponents do
  defmacro __using__(_) do
    quote do
      import WaruiWeb.Components.Accordion, only: [accordion: 1, native_accordion: 1]
      import WaruiWeb.Components.Alert, only: [flash: 1, flash_group: 1, alert: 1]
      import WaruiWeb.Components.Avatar, only: [avatar: 1, avatar_group: 1]
      import WaruiWeb.Components.Badge, only: [badge: 1]
      import WaruiWeb.Components.Banner, only: [banner: 1]
      ...
      import WaruiWeb.Components.Carousel, only: [carousel: 1]
      import WaruiWeb.Components.Chat, only: [chat: 1, chat_section: 1]
      import WaruiWeb.Components.CheckboxField, only: [checkbox_field: 1, group_checkbox: 1]
      ...
      import WaruiWeb.Components.Drawer, only: [drawer: 1]
      ...
      import WaruiWeb.Components.FormWrapper, only: [form_wrapper: 1]
      ...
      import WaruiWeb.Components.InputField, only: [input_field: 1]
      ...
      import WaruiWeb.Components.Modal, only: [modal: 1]
      import WaruiWeb.Components.NativeSelect, only: [native_select: 1, select_option_group: 1]
      import WaruiWeb.Components.Navbar, only: [navbar: 1]
      ...
      import WaruiWeb.Components.RadioField, only: [radio_field: 1, group_radio: 1]
      ...
      import WaruiWeb.Components.Tabs, only: [tabs: 1]
      ...
      import WaruiWeb.Components.Toast, only: [toast: 1, toast_group: 1]
      import WaruiWeb.Components.ToggleField, only: [toggle_field: 1]
