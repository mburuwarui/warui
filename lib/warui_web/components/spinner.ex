defmodule WaruiWeb.Components.Spinner do
  @moduledoc """
  The `WaruiWeb.Components.Spinner` module provides a dynamic and customizable loading spinner
  ...
  With its flexible design, the `WaruiWeb.Components.Spinner` module enables developers to provide
