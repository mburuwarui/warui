defmodule WaruiWeb.Components.Table do
  @moduledoc """
  `WaruiWeb.Components.Table` is a versatile component for creating customizable tables in a
  ...
  defp border_class(_, variant)
       when variant in ["default", "shadow", "transparent", "stripped", "hoverable"],
       do: nil
