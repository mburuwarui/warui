defmodule Warui.Chat.Conversation do
  use Ash.Resource,
    otp_app: :warui,
    domain: Warui.Chat,
    extensions: [AshOban],
  ...
  oban do
    triggers do
      trigger :name_conversation do
        ...
        worker_module_name Warui.Chat.Message.Workers.NameConversation
        scheduler_module_name Warui.Chat.Message.Schedulers.NameConversation
  ...
  actions do
    ...
    update :generate_name do
      ...
      change Warui.Chat.Conversation.Changes.GenerateName
    end
  ...
  relationships do
    has_many :messages, Warui.Chat.Message do
      public? true
    end
