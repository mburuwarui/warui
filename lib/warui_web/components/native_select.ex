defmodule WaruiWeb.Components.NativeSelect do
  @moduledoc """
  The `WaruiWeb.Components.NativeSelect` module provides a customizable native select component
  ...
  With built-in error handling and custom error messages, `WaruiWeb.Components.NativeSelect`
