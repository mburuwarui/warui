...
config :warui,
  ...
  ash_domains: [Warui.Catalog, Warui.Accounts]
...
config :warui, WaruiWeb.Endpoint,
  ...
  pubsub_server: Warui.PubSub,
  live_view: [signing_salt: "Lr/TbKyT"]
...
config :warui, Warui.Mailer, adapter: Swoosh.Adapters.Local
