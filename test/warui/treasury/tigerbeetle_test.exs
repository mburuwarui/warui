defmodule Warui.Treasury.TigerbeetleTest do
  use WaruiWeb.DataCase, async: false
  ...
  describe "account operations" do
    test "create_account/1 creates an account" do
      ...
      assert {:ok, account} = TigerbeetleService.create_account(attrs)
  ...
  defp generate_uuid do
    # This is a placeholder - implement your actual UUID generation
    # For example, if using the Ecto.UUID module:
    # Ecto.UUID.generate()
    <<1::128>>
  end
end
