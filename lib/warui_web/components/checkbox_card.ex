defmodule WaruiWeb.Components.CheckboxCard do
  @moduledoc """
  The `WaruiWeb.Components.CheckboxCard` module provides a customizable checkbox card component for Phoenix LiveView
