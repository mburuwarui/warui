defmodule WaruiWeb.Components.Alert do
  @moduledoc """
  WaruiWeb.Components.Alert module provides collection of alert components and helper functions for managing and displaying alerts
