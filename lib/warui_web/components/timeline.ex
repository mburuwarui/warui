defmodule WaruiWeb.Components.Timeline do
  @moduledoc """
  The `WaruiWeb.Components.Timeline` module is a versatile and customizable component
  ...
  defp color_class("white") do
    [
      "[&_.timeline-bullet]:bg-white [&_.timeline-bullet]:text-[#DADADA] [&_.timeline-vertical-line]:after:bg-white",
      "[&_.timeline-horizontal-line]:bg-white"
    ]
  end

  defp color_class("natural") do
    [
      "[&_.timeline-bullet]:bg-[#4B4B4B] [&_.timeline-bullet]:text-white [&_.timeline-vertical-line]:after:bg-[#4B4B4B]",
      "[&_.timeline-horizontal-line]:bg-[#4B4B4B]",
      "dark:[&_.timeline-bullet]:bg-[#DDDDDD] dark:[&_.timeline-bullet]:text-black dark:[&_.timeline-vertical-line]:after:bg-[#DDDDDD]",
      "dark:[&_.timeline-horizontal-line]:bg-[#DDDDDD]"
    ]
  end

  defp color_class("primary") do
    [
      "[&_.timeline-bullet]:bg-[#007F8C] [&_.timeline-bullet]:text-white [&_.timeline-vertical-line]:after:bg-[#007F8C]",
      "[&_.timeline-horizontal-line]:bg-[#007F8C]",
      "dark:[&_.timeline-bullet]:bg-[#01B8CA] dark:[&_.timeline-bullet]:text-black dark:[&_.timeline-vertical-line]:after:bg-[#01B8CA]",
      "dark:[&_.timeline-horizontal-line]:bg-[#01B8CA]"
    ]
  end

  defp color_class("secondary") do
    [
      "[&_.timeline-bullet]:bg-[#266EF1] [&_.timeline-bullet]:text-white [&_.timeline-vertical-line]:after:bg-[#266EF1]",
      "[&_.timeline-horizontal-line]:bg-[#266EF1]",
      "dark:[&_.timeline-bullet]:bg-[#6DAAFB] dark:[&_.timeline-bullet]:text-black dark:[&_.timeline-vertical-line]:after:bg-[#6DAAFB]",
      "dark:[&_.timeline-horizontal-line]:bg-[#6DAAFB]"
    ]
  end

  defp color_class("success") do
    [
      "[&_.timeline-bullet]:bg-[#0E8345] [&_.timeline-bullet]:text-white [&_.timeline-vertical-line]:after:bg-[#0E8345]",
      "[&_.timeline-horizontal-line]:bg-[#0E8345]",
      "[&_.timeline-bullet]:bg-[#06C167] [&_.timeline-bullet]:text-black [&_.timeline-vertical-line]:after:bg-[#06C167]",
      "[&_.timeline-horizontal-line]:bg-[#06C167]"
    ]
  end

  defp color_class("warning") do
    [
      "[&_.timeline-bullet]:bg-[#CA8D01] [&_.timeline-bullet]:text-white [&_.timeline-vertical-line]:after:bg-[#CA8D01]",
      "[&_.timeline-horizontal-line]:bg-[#CA8D01]",
      "[&_.timeline-bullet]:bg-[#FDC034] [&_.timeline-bullet]:text-black [&_.timeline-vertical-line]:after:bg-[#FDC034]",
      "[&_.timeline-horizontal-line]:bg-[#FDC034]"
    ]
  end

  defp color_class("danger") do
    [
      "[&_.timeline-bullet]:bg-[#DE1135] [&_.timeline-bullet]:text-white [&_.timeline-vertical-line]:after:bg-[#DE1135]",
      "[&_.timeline-horizontal-line]:bg-[#DE1135]",
      "[&_.timeline-bullet]:bg-[#FC7F79] [&_.timeline-bullet]:text-black [&_.timeline-vertical-line]:after:bg-[#FC7F79]",
      "[&_.timeline-horizontal-line]:bg-[#FC7F79]"
    ]
  end

  defp color_class("info") do
    [
      "[&_.timeline-bullet]:bg-[#0B84BA] [&_.timeline-bullet]:text-white [&_.timeline-vertical-line]:after:bg-[#0B84BA]",
      "[&_.timeline-horizontal-line]:bg-[#0B84BA]",
      "[&_.timeline-bullet]:bg-[#3EB7ED] [&_.timeline-bullet]:text-black [&_.timeline-vertical-line]:after:bg-[#3EB7ED]",
      "[&_.timeline-horizontal-line]:bg-[#3EB7ED]"
    ]
  end

  defp color_class("misc") do
    [
      "[&_.timeline-bullet]:bg-[#8750C5] [&_.timeline-bullet]:text-white [&_.timeline-vertical-line]:after:bg-[#8750C5]",
      "[&_.timeline-horizontal-line]:bg-[#8750C5]",
      "[&_.timeline-bullet]:bg-[#BA83F9] [&_.timeline-bullet]:text-black [&_.timeline-vertical-line]:after:bg-[#BA83F9]",
      "[&_.timeline-horizontal-line]:bg-[#BA83F9]"
    ]
  end

  defp color_class("dawn") do
    [
      "[&_.timeline-bullet]:bg-[#A86438] [&_.timeline-bullet]:text-white [&_.timeline-vertical-line]:after:bg-[#A86438]",
      "[&_.timeline-horizontal-line]:bg-[#A86438]",
      "[&_.timeline-bullet]:bg-[#DB976B] [&_.timeline-bullet]:text-black [&_.timeline-vertical-line]:after:bg-[#DB976B]",
      "[&_.timeline-horizontal-line]:bg-[#DB976B]"
    ]
  end

  defp color_class("silver") do
    [
      "[&_.timeline-bullet]:bg-[#868686] [&_.timeline-bullet]:text-white [&_.timeline-vertical-line]:after:bg-[#868686]",
      "[&_.timeline-horizontal-line]:bg-[#868686]",
      "[&_.timeline-bullet]:bg-[#A6A6A6] [&_.timeline-bullet]:text-black [&_.timeline-vertical-line]:after:bg-[#A6A6A6]",
      "[&_.timeline-horizontal-line]:bg-[#A6A6A6]"
    ]
  end

  defp color_class("dark") do
    [
      "[&_.timeline-bullet]:bg-[#282828] [&_.timeline-bullet]:text-white [&_.timeline-vertical-line]:after:bg-[#282828]",
      "[&_.timeline-horizontal-line]:bg-[#282828]"
    ]
  end
