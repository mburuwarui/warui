defmodule WaruiWeb.Components.ScrollArea do
  @moduledoc """
  The `WaruiWeb.Components.ScrollArea` module provides a customizable scroll area component for Phoenix LiveView
