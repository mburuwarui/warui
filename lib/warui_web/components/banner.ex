defmodule WaruiWeb.Components.Banner do
  @moduledoc """
  WaruiWeb.Components.Banner module provides components for rendering customizable banners in your **Phoenix LiveView**
  application.
