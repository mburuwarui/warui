defmodule WaruiWeb.Components.CheckboxField do
  @moduledoc """
  WaruiWeb.Components.CheckboxField Module Provides a customizable checkbox component for use in Phoenix LiveView forms.
  ...
  defp color_class("inverted") do
    [
      "text-zinc-200 dark:text-zinc-800",
      "checked:[&_.checkbox-field-wrapper_.checkbox-input]:text-zinc-500",
      "dark:checked:[&_.checkbox-field-wrapper_.checkbox-input]:text-zinc-600",
  ...
  defp translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(WaruiWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(WaruiWeb.Gettext, "errors", msg, opts)
    end
  end
end
